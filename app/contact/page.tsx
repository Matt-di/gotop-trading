        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              >
                <Card className="h-full text-center hover:shadow-xl transition-shadow duration-300 border-2 hover:border-blue-500 dark:hover:border-blue-400">
                  <CardHeader>
                  ...
                  {[
                    {
                      ...
                      description: "Get professional advice on your software, media, or printing needs",
                    },
                    {
                      title: "Custom Solutions",
                      description: "We design tailored solutions that perfectly fit your requirements",
                    },
                    {
                      title: "Quick Response",
                      description: "Our team responds promptly to all inquiries within 24 hours",
                    },
                    {
                      title: "Transparent Pricing",
                      description: "Receive clear, competitive quotes with no hidden costs",
                    },
                  ].map((item, index) => (
